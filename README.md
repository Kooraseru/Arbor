<div align="center">
  <img src="content/assets/brand/Billboard.svg" alt="Arbor" width="860">
  ...
  <table>
    <tr>
      ...
      <td align="center"><a href="content/locales/ja/README.md">日本語</a></td>
    </tr>
  </table>
</div>
...
The default-language wiki source is generated from `content/pages/wiki/` and
the locale whose metadata sets `default = true`.

- [Home](https://kooraseru.github.io/Arbor/)
- [Child Types API](https://kooraseru.github.io/Arbor/api/children/)
- [Runtime Loaders](https://kooraseru.github.io/Arbor/api/runtime-loaders/)
...
- [CHANGELOG.md](CHANGELOG.md) contains generated package-history summaries.
