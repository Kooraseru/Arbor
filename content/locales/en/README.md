<div align="center">
  ...
  <table>
    <tr>
      ...
      <td align="center">Japanese rewrite pending</td>
    </tr>
  </table>
</div>
...
The English wiki source lives under `content/locales/en/wiki/`. Examples
referenced by the wiki live under `content/locales/en/examples/`.
...
- Changelog entries are generated into publication output from `release-notes/`.
