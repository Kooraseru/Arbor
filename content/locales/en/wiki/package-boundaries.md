...
`Runtime.Children` is allowed because it exposes basic direct-child lookup helpers. It should not grow into tree synchronization, source-map ownership, or a runtime topology system.
